...
class OpaPsm2(MakefilePackage):
    ...
    patch('opa-psm2-install-prefix.patch', when='@11.2.68:11.2.173')
    patch('opa-psm2-install-prefix_185.patch', when='@11.2.185:')

    # patch to get the Makefile to use the spack compiler wrappers
    patch('opa-psm2-compiler.patch', when='@11.2.68:11.2.173',
          sha256='fe31fda9aaee13acb87d178af2282446196d2cc0b21163034573706110b2e2d6')
    patch('opa-psm2-compiler_185.patch', when='@11.2.185:')
